...
# The freeze-mark data model MOVED to sphero_rvr_core.freeze_marks (2026-08-21
# split; verbatim). Re-exported here so this module's own consumers keep
# working until their scheduled deletion -- nothing below uses the symbols.
from sphero_rvr_core.freeze_marks import (  # noqa: F401,E402
    FreezeMark, FreezeMarkSet, freeze_mark_pose, merge_positions)
